package com.trailerplan.idserver.exception.handler;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(final MethodArgumentNotValidException ex, final HttpHeaders headers, final HttpStatus status,
		...
		return handleExceptionInternal(ex, new ApiResponseDto(false, error), new HttpHeaders(), HttpStatus.BAD_REQUEST, request);
	}
}
